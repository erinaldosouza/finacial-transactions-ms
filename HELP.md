...
* The original package name 'com.test-case.financial-transaction.financial-transaction-ms' is invalid and this project uses 'com.test_case.financial_transactions_ms.financial_transaction_ms' instead.
